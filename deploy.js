...
try {
  ...
  const wsProvider = new WsProvider('https://github.com/VitaliiMykytyn');
  ...
  const PHRASE = 'spot vacuum kit clip broccoli hundred salt labor marine sauce consider endless';
